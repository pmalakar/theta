...
parser.add_argument("-a", "--ostaccess", action="store_true", dest="ostaccess_flag", required=False, help="show access count of OSTs")
...
if ostaccess_flag == True:
    ...
    for key, value in finfo_dict.items() :
        for ostnum in value['OST_list']:
            ...
            posix_write_ost.append(posix_ost)
        for ostnum in value['OST_list']:
